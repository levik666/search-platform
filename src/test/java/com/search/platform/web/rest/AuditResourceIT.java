package com.search.platform.web.rest;
...
import com.search.platform.SearchPlatformApp;
import com.search.platform.config.TestSecurityConfiguration;
import com.search.platform.config.audit.AuditEventConverter;
import com.search.platform.domain.PersistentAuditEvent;
import com.search.platform.repository.PersistenceAuditEventRepository;
import com.search.platform.security.AuthoritiesConstants;
import com.search.platform.service.AuditEventService;
...
@SpringBootTest(classes = { SearchPlatformApp.class, TestSecurityConfiguration.class })
@Transactional
